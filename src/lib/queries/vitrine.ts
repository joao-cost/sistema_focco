...
export const VITRINE_ACCENTS = [
  { bg: "bg-focco-green", bgSoft: "bg-focco-green/10", text: "text-focco-green-dark", border: "border-focco-green-pale" },
  { bg: "bg-focco-blue", bgSoft: "bg-focco-blue/10", text: "text-focco-blue-dark", border: "border-focco-blue-pale" },
  { bg: "bg-focco-orange", bgSoft: "bg-focco-orange/10", text: "text-focco-orange-dark", border: "border-focco-orange-pale" },
  { bg: "bg-focco-pink", bgSoft: "bg-focco-pink/10", text: "text-focco-pink-dark", border: "border-focco-pink-pale" },
  { bg: "bg-focco-red", bgSoft: "bg-focco-red/10", text: "text-focco-red-dark", border: "border-focco-red-pale" },
] as const;
